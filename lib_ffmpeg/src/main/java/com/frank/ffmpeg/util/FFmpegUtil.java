...
public class FFmpegUtil {
    ...
    public static String[] transformMp3(String srcFile, String targetFile) {
        String transformAudioCmd = "ffmpeg -i %s %s";
        // -c:a libfaac -b:a -ac 1 -ar 44100 128k
     ...
     */
    @SuppressLint("DefaultLocale")
    public static String[] concatAudio(List<String> srcFiles, String targetFile) {
...
//        return concatAudioCmd.split(" ");//以空格分割为字符串数组
        ...
        builder.append(String.format(" -filter_complex concat=n=%d:v=0:a=1[a] -map [a] -ac 1 -ar 44100 -ab 128000 ", srcFiles.size()));
