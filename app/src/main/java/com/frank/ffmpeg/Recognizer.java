...
public class Recognizer {
     ...
     * 测试参数填在这里
     */
    public void start(Context context, String filePath) {
        ...
        params.put(SpeechConstant.IN_FILE, filePath);
            ...
            public void handleMessage(Message msg) {
                if (msg.what == 100) {
                    ...
                    synchronized (autoCheck) {
                        ...
                        Log.d(TAG, String.format("call handleMessage(): msg = [%s]", message));
    ...
    public void init(final Context context, EventListener listener) {
...
//    @Override
    ...
    private void printLog(String text) {
        ...
        text += "\n";
        Log.d(TAG, String.format("call printLog(): text = [%s]", text));
    }
}
